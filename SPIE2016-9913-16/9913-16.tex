...
JWST and LSST have requirements for accurate world coordinate conversions that can not be represented in the current FITS-WCS framework\cite{2013ASPC..475...49H,2002A&A...395.1077C,2015A&C....12..133T} and none of the current extensions handling focal plane distortions are suitably flexible\cite{2012SPIE.8451E..1MS,2012tpv}.
...
If Astropy and LSST can not share sky to pixel region handling code directly there is a possibility that STC could be adopted to allow interoperability.
