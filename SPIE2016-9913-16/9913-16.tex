...
Repackaging just the source detection, deblending, and measurement algorithms (roughly equivalent to Astromatic's ubiquitous SExtractor) as Astropy affiliate packages would make a very important subset of LSST's algorithms more readily available to a broader community.
